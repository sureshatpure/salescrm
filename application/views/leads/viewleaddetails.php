                                        ...
                                        <span class="row-fluid">
                                            <span class="recordLabel font-x-x-large textOverflowEllipsis pushDown span" title="">
                                                ...
                                                <?php if ($closedlead == 8) { ?>
                                                    ...
                                                    <div style="content">
                                                        <p  style="width:900px;font-family:arial;color:red;font-size:15px; text-align:left;margin-left:10px;"><?php echo $leaddetails['0']['lead_close_comments']; ?></p>
                                                    </div>
                                                ...
                                                foreach ($grpperm as $key => $value) {
                                                    ...
                                                    if ($value['groupname'] == 'Edit' && $closedlead!=8) {
                                                        ?>
